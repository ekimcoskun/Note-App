...
var dateElement = document.querySelector('#last-edited');
...
titleElement.addEventListener('input', function (e) {
    ...
    dateElement.textContent = (0, _views.generateLastEdited)(note.updatedAt);
});
...
var renderNotes = function renderNotes() {
    ...
    var notes = (0, _notes.sortNotes)(filters.sortBy);
